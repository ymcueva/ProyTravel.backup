...
public class PaqueteTuristicoBean {
	...
	private String nombreEstadoPaquete;
	private String codigoEstadoPaquete;
	...
	public String getNombreEstadoPaquete() {
		return nombreEstadoPaquete;
	}
	public void setNombreEstadoPaquete(String nombreEstadoPaquete) {
		this.nombreEstadoPaquete = nombreEstadoPaquete;
	}
	public String getCodigoEstadoPaquete() {
		return codigoEstadoPaquete;
	}
	public void setCodigoEstadoPaquete(String codigoEstadoPaquete) {
		this.codigoEstadoPaquete = codigoEstadoPaquete;
	}
	...
	public int getIdPaqueteDeta() {
		return idPaqueteDeta;
	}
	public void setIdPaqueteDeta(int idPaqueteDeta) {
		this.idPaqueteDeta = idPaqueteDeta;
	}
